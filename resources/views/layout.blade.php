    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ @route('beranda') }}" class="nav-link {{  request()->route()->named('beranda') ? 'active' : ''}}">
          ...
          <li class="nav-item">
            <a href="{{ route('pelanggan') }}" class="nav-link {{  request()->route()->named('pelanggan') ? 'active' : ''}}">
          ...
          <li class="nav-item">
            <a href="{{ route('paket') }}" class="nav-link {{  request()->route()->named('paket') ? 'active' : ''}}">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">@yield('page_subname')</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
